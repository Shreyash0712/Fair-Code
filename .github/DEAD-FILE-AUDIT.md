...
- `assets/og/*.png` - 38 files, matching exactly: 36 explainer slugs (one per `explainers/*.md`)
  plus `home.png` (`index.html`'s `og:image`) and `profiler.png` (`profiler.html`'s). No orphans,
  no gaps.
