# Audit 03: German Credit Lending - Lending Bias - Reproducibility
...
```bash
python3 "German Credit Lending/unfair.py"   # biased baseline (protected attribute included)
python3 "German Credit Lending/fair.py"     # mitigated (protected attribute + proxies dropped)
```

## What the audit controls

- Protected attribute(s): Age
- Proxy feature(s) removed in `fair.py`: Employment Tenure
