# Audit 01: COMPAS - Criminal Justice Bias - Reproducibility
...
python3 "COMPAS/fair.py"     # mitigated (protected attribute + proxies dropped)
```

## What the audit controls

- Protected attribute(s): Race
- Proxy feature(s) removed in `fair.py`: Custody Status
