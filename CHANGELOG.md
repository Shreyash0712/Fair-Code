...
## [2.0.9] - 08 Aug 2026 *(pending - will be tagged after the paper is published)*
### Added
...
### Changed
- Traction refreshed as the project grew (see `METRICS.md`): combined social reach ~25K -> **26K+**; **Countries reached** (16, via Instagram + LinkedIn audience insights) tracked for the first time. Applied across `METRICS.md`, `README.md`, and `ROADMAP.md`.
